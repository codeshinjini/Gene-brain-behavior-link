function [ Thresh, error_subspace ] = Calculate_Alpha( FINAL_FEATS, labels, Curveoption )
...
%Choose alpha such that the absolute value of the relative change does not exceed cutoff%
cutoff = 0.5; %0.015; 
