START_DIR = /afs/.ece.cmu.edu/project/cbi/users/gustavor/Shinjini/Autism/TBM_features

MATLAB_ROOT = /afs/ece.cmu.edu/support/matlab/2013a
MAKEFILE = GPReduce_mex.mk

include GPReduce_mex.mki
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/GPReduce"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/GPReduce/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/GPReduce/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/GPReduce/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
